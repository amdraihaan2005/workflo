        ...
        >
            <div className = "mb-3 flex w-full">
                <div 
                    ...
                    style={{backgroundColor: statusColor[status] || "#ccc"
                    }}
                />
...
const Task = ({task}: TaskProps) => {
    ...
    const formattedStartDate = task.startDate ? format(new Date(task.startDate), "P") : null;
    const formattedDueDate = task.dueDate ? format(new Date(task.dueDate), "P") : null;
                ...
                <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-2">
                        {taskTagsSplit.map((tag) => (
                            <div key={tag} className="rounded-full bg-blue-200 px-2 py-1 text-xs"
                            >
                                {" "}
                                {tag}
                            </div>
